...
public:
  ...
  void end_changes(int index) override { push_to_audio(index, param_queue_event_type::end_edit); }
  void begin_changes(int index) override { push_to_audio(index, param_queue_event_type::begin_edit); }
};

...
public:
  ...
  virtual std::vector<std::string> module_menu_items() const { return {}; };
  ...
  virtual void clear(plugin_state* state, int module, int slot, int action) {};
  virtual void move(plugin_state* state, int module, int source_slot, int target_slot, int action) {};
  virtual void copy(plugin_state* state, int module, int source_slot, int target_slot, int action) {};
  virtual void swap(plugin_state* state, int module, int source_slot, int target_slot, int action) {};
};

...
function(declare_vst3_target WRAPPER_NAME WRAPPER_SRC PLUGIN_NAME IS_FX)
  ...
  if(CMAKE_CXX_COMPILER_ID STREQUAL "MSVC")
    ...
    add_custom_command(TARGET ${TARGET_NAME} POST_BUILD COMMAND ${CMAKE_COMMAND} -E copy_directory ${CMAKE_SOURCE_DIR}/resources "${CMAKE_SOURCE_DIR}/dist/${BUILD_TYPE}/win/${TARGET_NAME}/Contents/Resources")
  elseif(CMAKE_CXX_COMPILER_ID STREQUAL "GNU")
    ...
    add_custom_command(TARGET ${TARGET_NAME} POST_BUILD COMMAND ${CMAKE_COMMAND} -E copy_directory ${CMAKE_SOURCE_DIR}/resources "${CMAKE_SOURCE_DIR}/dist/${BUILD_TYPE}/linux/${TARGET_NAME}/Contents/Resources")
  else()
    message(FATAL_ERROR)
  endif()
endfunction()
...
function(declare_clap_target WRAPPER_NAME WRAPPER_SRC PLUGIN_NAME IS_FX)
  ...
  if(CMAKE_CXX_COMPILER_ID STREQUAL "MSVC")
    ...
    add_custom_command(TARGET ${TARGET_NAME} POST_BUILD COMMAND ${CMAKE_COMMAND} -E copy_directory ${CMAKE_SOURCE_DIR}/resources "${CMAKE_SOURCE_DIR}/dist/${BUILD_TYPE}/win/${TARGET_NAME}")
  elseif(CMAKE_CXX_COMPILER_ID STREQUAL "GNU")
    set_target_properties(${TARGET_NAME} PROPERTIES PREFIX "")
    ...
    add_custom_command(TARGET ${TARGET_NAME} POST_BUILD COMMAND ${CMAKE_COMMAND} -E copy_directory ${CMAKE_SOURCE_DIR}/resources "${CMAKE_SOURCE_DIR}/dist/${BUILD_TYPE}/linux/${TARGET_NAME}")
  else()
    message(FATAL_ERROR)
  endif()
endfunction()
...
function(declare_vst3_target WRAPPER_NAME WRAPPER_SRC PLUGIN_NAME IS_FX)
  ...
  elseif(CMAKE_CXX_COMPILER_ID STREQUAL "GNU")
    ...
    add_custom_command(TARGET ${TARGET_NAME} POST_BUILD COMMAND ${CMAKE_COMMAND} -E copy_directory ${CMAKE_SOURCE_DIR}/presets "${CMAKE_SOURCE_DIR}/dist/${CMAKE_BUILD_TYPE}/linux/${TARGET_NAME}/Contents/Resources/presets")
  else()
    message(FATAL_ERROR)
  endif()
endfunction()
...
function(declare_clap_target WRAPPER_NAME WRAPPER_SRC PLUGIN_NAME IS_FX)
  ...
  elseif(CMAKE_CXX_COMPILER_ID STREQUAL "GNU")
    ...
    add_custom_command(TARGET ${TARGET_NAME} POST_BUILD COMMAND ${CMAKE_COMMAND} -E copy_directory ${CMAKE_SOURCE_DIR}/presets "${CMAKE_SOURCE_DIR}/dist/${CMAKE_BUILD_TYPE}/linux/${TARGET_NAME}/presets")
  else()
    message(FATAL_ERROR)
  endif()
endfunction()
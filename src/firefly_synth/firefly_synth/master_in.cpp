...
int aux_count = 3;
enum { section_linked, section_aux };
enum { output_mod, output_pb, output_aux };
enum { param_mod, param_pb, param_pb_range, param_aux, param_count };
...
master_in_topo(int section, gui_colors const& colors, gui_position const& pos)
{
  ...
  result.sections.emplace_back(make_param_section(section_linked,
    ...
    make_param_section_gui({ 0, 0 }, gui_dimension({ 1 }, { 1, 1, gui_dimension::auto_size }))));

...
module_topo
global_smoothing_topo(std::string const& vendor, std::string const& full_name, int section, gui_position const& pos)
{
  std::vector<int> row_distribution = { 1 };
  std::vector<int> column_distribution = { 1 };
  module_topo result(make_module(
    make_topo_info("{79A688D2-4223-489A-B2E4-3E78A7975C4D}", true, "Glob Smt", "Glob Smt", "Glob Smt", module_global_smoothing, 1),
  ...
  auto& midi_smooth = result.params.emplace_back(make_param(
    ...
    make_param_gui_single(section_main, gui_edit_type::hslider, { 0, 0, 1, 4 },
  ...
  auto& bpm_smooth = result.params.emplace_back(make_param(
    ...
    make_param_gui_single(section_main, gui_edit_type::hslider, { 0, 4, 1, 2 },
      make_label(gui_label_contents::name, gui_label_align::left, gui_label_justify::near))));
  ...
  auto& auto_smooth = result.params.emplace_back(make_param(
    ...
    make_param_gui_single(section_main, gui_edit_type::hslider, { 1, 0, 1, 6 },

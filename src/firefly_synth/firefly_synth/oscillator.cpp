...
enum { scratch_basic_sin_mix, scratch_basic_saw_mix, scratch_basic_tri_mix, scratch_basic_sqr_mix, scratch_basic_count };
static int constexpr scratch_count = std::max({ (int)scratch_basic_count });

...
enum { section_type, section_sync_on, section_sync_params, section_uni, section_basic, section_basic_pw, section_dsf, section_rand };
enum { 
...
{ 
  ...
  result.sections.emplace_back(make_param_section(section_sync_params,
    ...
    make_param_section_gui({ 0, 2, 2, 1 }, gui_dimension({ 1, 1 }, { gui_dimension::auto_size_all, 1 }), gui_label_edit_cell_split::horizontal)));

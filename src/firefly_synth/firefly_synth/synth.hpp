...
enum {
  module_external_audio, module_midi, module_gcv_cv_matrix, module_master_in, module_master_smooth,
...
plugin_base::module_topo master_smooth_topo(int section, plugin_base::gui_position const& pos);

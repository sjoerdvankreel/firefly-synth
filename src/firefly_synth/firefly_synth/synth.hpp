...
enum {
  ...
  module_vaudio_matrix, module_am_matrix, module_fm_matrix, module_osc, module_vfx, module_voice_out,
...
plugin_base::module_topo fm_matrix_topo(int section, plugin_base::gui_colors const& colors, plugin_base::gui_position const& pos, plugin_base::plugin_topo const* plugin);

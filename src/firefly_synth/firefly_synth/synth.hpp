...
enum {
  module_midi, module_master_in, module_glfo, module_gcv_matrix, /*module_voice_in, */ module_vlfo,
  module_env, module_vcv_matrix, module_vaudio_matrix, module_osc, module_vfx, module_voice_mix_out, 
  module_voice_mix_in, module_gaudio_matrix, module_gfx, module_master_out, module_monitor, module_count };
...
plugin_base::module_topo voice_mix_out_topo(int section);
...
plugin_base::module_topo master_out_topo(int section, plugin_base::gui_colors const& colors, plugin_base::gui_position const& pos);

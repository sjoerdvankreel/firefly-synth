...
extern int const global_in_param_tuning_mode; // TODO
...
plugin_base::module_topo master_settings_topo(std::string const& vendor, std::string const& full_name, int section, plugin_base::gui_position const& pos);

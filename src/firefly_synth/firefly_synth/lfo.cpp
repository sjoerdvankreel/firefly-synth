...
enum { param_mode, param_rate, param_tempo, param_type, param_filter, param_seed, param_steps, param_x, param_y, param_phase };
enum { 
...
lfo_topo(int section, gui_colors const& colors, gui_position const& pos, bool global)
{
  ...
  result.params[param_x].gui.label_reference_text = result.params[param_steps].info.tag.short_name;

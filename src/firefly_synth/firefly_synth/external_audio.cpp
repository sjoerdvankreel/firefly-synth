...
external_audio_topo(int section, bool is_fx)
{
  module_topo result(make_module(
    make_topo_info("{B5D634E6-4D8A-4C49-9926-1CE21C9B465F}", true, "External Audio", "External Audio", "Ext.Audio", module_external_audio, 1),
    make_module_dsp(module_stage::input, module_output::audio, 0, {
      make_module_dsp_output(false, make_topo_info("{EA060413-A2E3-4AD2-98D0-F6FE5F7B987E}", true, "External Audio", "External Audio", "Ext.Audio", output_ext_audio, 1)) }),

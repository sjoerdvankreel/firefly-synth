...
voice_note_topo(int section)
{
  module_topo result(make_module(
    make_topo_info("{4380584E-6CC5-4DA5-A533-17A9A1777476}", true, "Note", "Note", "Note", module_voice_note, 1),
    make_module_dsp(module_stage::voice, module_output::cv, 0, {
      make_module_dsp_output(true, make_topo_info("{376846A2-33FC-4DB0-BCB9-7A43A8488A7F}", true, "Key", "Key", "Key", output_key, 1)),

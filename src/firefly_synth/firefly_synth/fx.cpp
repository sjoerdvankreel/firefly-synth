...
{
  auto const voice_info = make_topo_info("{4901E1B1-BFD6-4C85-83C4-699DC27C6BC4}", "Voice FX", "V.FX", true, module_vfx, 5);
  auto const global_info = make_topo_info("{31EF3492-FE63-4A59-91DA-C2B4DD4A8891}", "Global FX", "G.FX", true, module_gfx, 5);
  ...
  auto& delay_tempo = result.params.emplace_back(make_param(
    ...
    make_param_dsp_block(param_automate::automate), make_domain_timesig_default(false, {3, 16}),

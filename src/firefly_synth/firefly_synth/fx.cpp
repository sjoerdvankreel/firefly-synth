...
enum { section_main, section_svf, section_comb, section_dist, section_delay, section_reverb };
...
fx_topo(int section, gui_position const& pos, bool global, bool is_fx)
{
  ...
  auto& dist_skew_in = result.params.emplace_back(make_param(
    ...
    make_param_gui_single(section_dist, gui_edit_type::autofit_list, { 0, 0 },
      make_label(gui_label_contents::name, gui_label_align::left, gui_label_justify::near))));
  ...
  auto& dist_skew_in_amt = result.params.emplace_back(make_param(
    ...
    make_param_gui_single(section_dist, gui_edit_type::knob, { 0, 2 }, make_label_none())));
  ...
  auto& dist_skew_out = result.params.emplace_back(make_param(
    ...
    make_param_dsp_automate_if_voice(!global), make_domain_item(wave_skew_type_items(), "Off"),
    make_param_gui_single(section_dist, gui_edit_type::autofit_list, { 1, 0 },
      make_label(gui_label_contents::name, gui_label_align::left, gui_label_justify::near))));
  ...
  auto& dist_skew_out_amt = result.params.emplace_back(make_param(
    ...
    make_param_dsp_accurate(param_automate::modulate), make_domain_percentage_identity(0.5, 0, true),
    make_param_gui_single(section_dist, gui_edit_type::knob, { 1, 2 }, make_label_none())));
  ...
  auto& dist_over = result.params.emplace_back(make_param(
    ...
    make_param_gui_single(section_dist, gui_edit_type::autofit_list, { 1, 3 },
      make_label(gui_label_contents::name, gui_label_align::left, gui_label_justify::near))));
  ...
  auto& dist_res = result.params.emplace_back(make_param(
    ...
    make_param_dsp_accurate(param_automate::modulate), make_domain_percentage_identity(0, 0, true),
    make_param_gui_single(section_dist, gui_edit_type::knob, { 1, 5 },
      make_label(gui_label_contents::name, gui_label_align::left, gui_label_justify::near))));
  ...
  auto& dist_clip = result.params.emplace_back(make_param(
    ...
    make_param_gui_single(section_dist, gui_edit_type::autofit_list, { 0, 7 },
      make_label(gui_label_contents::name, gui_label_align::left, gui_label_justify::near))));
  ...
  auto& dist_clip_expo = result.params.emplace_back(make_param(
    ...
    make_param_gui_single(section_dist, gui_edit_type::hslider, { 1, 7 },
      make_label(gui_label_contents::name, gui_label_align::left, gui_label_justify::near))));
  ...
  auto& dist_gain = result.params.emplace_back(make_param(
    ...
    make_param_gui_single(section_dist, gui_edit_type::hslider, { 0, 9 },
      make_label(gui_label_contents::name, gui_label_align::left, gui_label_justify::near))));
  ...
  auto& dist_mix = result.params.emplace_back(make_param(
    ...
    make_param_gui_single(section_dist, gui_edit_type::hslider, { 1, 9 },
      make_label(gui_label_contents::name, gui_label_align::left, gui_label_justify::near))));
  ...
  auto& delay = result.sections.emplace_back(make_param_section(section_delay,
    make_topo_tag_basic("{E92225CF-21BF-459C-8C9D-8E50285F26D4}", "Delay"),
    make_param_section_gui({ 0, 1, 2, 2 }, { { 1, 1 }, { 
  ...
  auto& delay_sync = result.params.emplace_back(make_param(
    ...
    make_param_gui_single(section_delay, gui_edit_type::toggle, { 1, 0 },
      make_label(gui_label_contents::name, gui_label_align::left, gui_label_justify::near))));
  ...
  auto& delay_fdbk_time_l = result.params.emplace_back(make_param(
    ...
    make_param_gui_single(section_delay, gui_edit_type::hslider, { 1, 2 },
      make_label(gui_label_contents::name, gui_label_align::left, gui_label_justify::near))));
  ...
  auto& delay_fdbk_tempo_l = result.params.emplace_back(make_param(
    ...
    make_param_gui_single(section_delay, gui_edit_type::list, { 1, 2 },
      make_label(gui_label_contents::name, gui_label_align::left, gui_label_justify::near))));
  ...
  auto& delay_fdbk_time_r = result.params.emplace_back(make_param(
    ...
    make_param_dsp_input(false, param_automate::none), make_domain_log(0, dly_max_sec, 1, 1, 3, "Sec"),
    make_param_gui_single(section_delay, gui_edit_type::hslider, { 1, 4 },
      make_label(gui_label_contents::name, gui_label_align::left, gui_label_justify::near))));
  ...
  auto& delay_fdbk_tempo_r = result.params.emplace_back(make_param(
    ...
    make_param_gui_single(section_delay, gui_edit_type::list, { 1, 4 },
      make_label(gui_label_contents::name, gui_label_align::left, gui_label_justify::near))));
  ...
  auto& delay_hold_time = result.params.emplace_back(make_param(
    ...
    make_param_gui_single(section_delay, gui_edit_type::hslider, { 1, 6 },
      make_label(gui_label_contents::name, gui_label_align::left, gui_label_justify::near))));
  ...
  auto& delay_hold_tempo = result.params.emplace_back(make_param(
    ...
    make_param_gui_single(section_delay, gui_edit_type::list, { 1, 6 },
      make_label(gui_label_contents::name, gui_label_align::left, gui_label_justify::near))));

...
enum { section_main, section_svf, section_comb_top, section_comb_bottom, section_dist_top, section_dist_bottom, 
...
fx_topo(int section, gui_position const& pos, bool global, bool is_fx)
{
  ...
  result.sections.emplace_back(make_param_section(section_main,
    ...
    make_param_section_gui({ 0, 0, 2, 1 }, { { 1, 1 }, { gui_dimension::auto_size, 1 } }, gui_label_edit_cell_split::horizontal)));

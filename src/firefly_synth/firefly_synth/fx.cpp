...
enum { section_main, section_svf, section_comb, section_dist, section_delay_left, section_delay_right, section_reverb };
...
fx_topo(int section, gui_position const& pos, bool global, bool is_fx)
{
  ...
  auto& distortion = result.sections.emplace_back(make_param_section(section_dist,
    make_topo_tag_basic("{4FD908CC-0EBA-4ADD-8622-EB95013CD429}", "Distortion"),

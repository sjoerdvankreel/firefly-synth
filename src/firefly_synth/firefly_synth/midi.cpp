...
midi_topo(int section)
{
  module_topo result(make_module(
    ...
    make_module_dsp(module_stage::input, module_output::cv, 0, {
      make_module_dsp_output(true, make_topo_info("{D38E46EA-4064-410C-BB33-DB6DA418463B}", true, "CP", "CP", "CP", midi_output_cp, 1)),
      make_module_dsp_output(true, make_topo_info("{C3A35C9F-3F80-4DE0-8C8D-D18D340F9DBC}", true, "PB", "PB", "PB", midi_output_pb, 1)),

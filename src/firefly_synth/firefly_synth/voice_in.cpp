...
voice_topo(int section, bool out)
{
  ...
  auto const in_info = make_topo_info("{70C5721B-4D0C-4ED3-B5B9-3D3E0D46C62E}", "Voice", module_voice_mix_in, 1);
  auto const out_info = make_topo_info("{94CC6FFA-2C0F-4B72-A484-65CD2974D288}", "Voice", module_voice_mix_out, 1);

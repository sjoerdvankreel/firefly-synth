...
monitor_topo(int section, gui_colors const& colors, gui_position const& pos, int polyphony, bool is_fx)
{
  module_topo result(make_module(
    make_topo_info("{C20F2D2C-23C6-41BE-BFB3-DE9EDFB051EC}", true, "Monitor", "Monitor", "Monitor", module_monitor, 1),
  ...
  result.sections.emplace_back(make_param_section(section_main,
    make_topo_tag("{988E6A84-A012-413C-B33B-80B8B135D203}", true, "Main", "Main", "Main"),
    make_param_section_gui({ 0, 0 }, { { 1 } , column_distribution })));
  auto& gain = result.params.emplace_back(make_param(
    make_topo_info("{6AB939E0-62D0-4BA3-8692-7FD7B740ED74}", true, "Gain", "Gain", "Gain", param_gain, 1),
  ...
  auto& cpu = result.params.emplace_back(make_param(
    make_topo_info("{55919A34-BF81-4EDF-8222-F0F0BE52DB8E}", true, "Cpu", "Cpu", "Cpu", param_cpu, 1),
    make_param_dsp_output(), make_domain_percentage(0, 9.99, 0, 0, false),
  ...
  auto& hi_cpu = result.params.emplace_back(make_param(
    make_topo_info("{2B13D43C-FFB5-4A66-9532-39B0F8258161}", true, "High Cpu", "High", "High", param_hi_mod_cpu, 1),
  ...
  auto& hi_module = result.params.emplace_back(make_param(
    make_topo_info("{BE8AF913-E888-4A0E-B674-8151AF1B7D65}", true, "Hi Cpu Module", "Hi Cpu Module", "Hi Cpu Module", param_hi_mod, 1),
  ...
  auto& voices = result.params.emplace_back(make_param(
    make_topo_info("{2827FB67-CF08-4785-ACB2-F9200D6B03FA}", true, "Voices", "Voices", "Voices", param_voices, 1),
  ...
  auto& thrs = result.params.emplace_back(make_param(
    make_topo_info("{FD7E410D-D4A6-4AA2-BDA0-5B5E6EC3E13A}", true, "Threads", "Thrds", "Thrds", param_threads, 1),
    make_param_dsp_output(), make_domain_step(0, polyphony, 0, 0),

...
{
  auto& result = store_component<grid_component>(store, gui_dimension{ { 1, 1 } , { 6, 6, 6, 7, 7 } }, 2);
  result.add(gui->make_load_button(), { 0, 0 });
  result.add(gui->make_save_button(), { 0, 1 });
  result.add(gui->make_clear_button(), { 0, 2 });
  result.add(gui->make_init_button(), { 0, 3 });
...
synth_topo()
{
  ...
  result->gui.dimension.column_sizes = { 16, 12, 12, 10, 13, 13 };
  ...
  result->gui.custom_sections[custom_section_gfx_graph] = make_custom_section_gui(
    custom_section_gfx_graph, { 2, 3, 1, 1 }, global_colors, [](auto* gui, auto* lnf, auto store)
  ...
  result->gui.custom_sections[custom_section_glfo_graph] = make_custom_section_gui(
    custom_section_glfo_graph, { 3, 3, 1, 1 }, global_colors, [](auto* gui, auto* lnf, auto store)
  ...
  result->gui.custom_sections[custom_section_osc_graph] = make_custom_section_gui(
    custom_section_osc_graph, { 5, 3, 1, 1 }, voice_colors, [](auto* gui, auto* lnf, auto store)
  ...
  result->gui.custom_sections[custom_section_vfx_graph] = make_custom_section_gui(
    custom_section_vfx_graph, { 6, 3, 1, 1 }, voice_colors, [](auto* gui, auto* lnf, auto store)
  ...
  result->gui.custom_sections[custom_section_vlfo_graph] = make_custom_section_gui(
    custom_section_vlfo_graph, { 7, 3, 1, 1 }, voice_colors, [](auto* gui, auto* lnf, auto store)
  ...
  result->gui.custom_sections[custom_section_env_graph] = make_custom_section_gui(
    custom_section_env_graph, { 8, 3, 1, 1 }, voice_colors, [](auto* gui, auto* lnf, auto store)
  ...
  result->gui.module_sections[module_section_matrices] = make_module_section_gui_tabbed(
    "{11A46FE6-9009-4C17-B177-467243E171C8}", module_section_matrices, { 1, 4, 8, 2 },

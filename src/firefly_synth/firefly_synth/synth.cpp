...
synth_topo(bool is_fx)
{
  ...
  result->gui.dimension.column_sizes = { 47, 8, 19, 19 };
  ...
  result->gui.custom_sections[custom_section_main_graph] = make_custom_section_gui(
    custom_section_main_graph, { 0, 1, 1, 1 }, custom_colors, [](auto* gui, auto* lnf, auto store)
  ...
  result->gui.custom_sections[custom_section_gfx_graph] = make_custom_section_gui(
    custom_section_gfx_graph, { section_voffset + 2, 1, 1, 1 }, global_colors, [](auto* gui, auto* lnf, auto store)
  ...
  result->gui.custom_sections[custom_section_glfo_graph] = make_custom_section_gui(
    custom_section_glfo_graph, { section_voffset + 3, 1, 1, 1 }, global_colors, [](auto* gui, auto* lnf, auto store)
  ...
  result->gui.custom_sections[custom_section_cv_matrix_graphs] = make_custom_section_gui(
    custom_section_cv_matrix_graphs, { is_fx? 3: 8, 2, 1, 2 }, matrix_colors, [](auto* gui, auto* lnf, auto store)
  ...
  if(!is_fx)
  {
    result->gui.custom_sections[custom_section_osc_graph] = make_custom_section_gui(
      custom_section_osc_graph, { 4, 1, 1, 1 }, voice_colors, [](auto* gui, auto* lnf, auto store)
    ...
    result->gui.custom_sections[custom_section_vfx_graph] = make_custom_section_gui(
      custom_section_vfx_graph, { 6, 1, 1, 1 }, voice_colors, [](auto* gui, auto* lnf, auto store)
    ...
    result->gui.custom_sections[custom_section_vlfo_graph] = make_custom_section_gui(
      custom_section_vlfo_graph, { 7, 1, 1, 1 }, voice_colors, [](auto* gui, auto* lnf, auto store)
    ...
    result->gui.custom_sections[custom_section_env_graph] = make_custom_section_gui(
      custom_section_env_graph, { 8, 1, 1, 1 }, voice_colors, [](auto* gui, auto* lnf, auto store)
    ...
    result->gui.custom_sections[custom_section_osc_osc_matrix_graph] = make_custom_section_gui(
      custom_section_osc_osc_matrix_graph, { 4, 2, 1, 1 }, matrix_colors, [](auto* gui, auto* lnf, auto store)
  ...
  result->gui.module_sections[module_section_glfo] = make_module_section_gui(
    "{96C75EE5-577E-4508-A85A-E92FF9FD8A4D}", module_section_glfo, { section_voffset + 3, 0, 1, 1 }, { 1, 1 });
  result->gui.module_sections[module_section_gfx] = make_module_section_gui(
    "{654B206B-27AE-4DFD-B885-772A8AD0A4F3}", module_section_gfx, { section_voffset + 2, 0, 1, 1 }, { 1, 1 });
  result->gui.module_sections[module_section_master_in] = make_module_section_gui(
    "{F9578AAA-66A4-4B0C-A941-4719B5F0E998}", module_section_master_in, { section_voffset + 1, 0, 1, 1 }, { { 1 }, { 1 } });
  result->gui.module_sections[module_section_master_out] = make_module_section_gui(
    "{F77335AC-B701-40DA-B4C2-1F55DBCC29A4}", module_section_master_out, { section_voffset + 1, 1, 1, 1 }, { { 1 }, { 1 } });
  ...
  result->gui.module_sections[module_section_osc_osc_matrix] = make_module_section_gui(
    "{7529B223-CB9F-429F-A547-2E3480A896A6}", module_section_osc_osc_matrix, { 1, 2, 3, 1 }, { 1, 1 });
  ...
  result->gui.module_sections[module_section_cv_matrices] = make_module_section_gui_tabbed(
    "{D450B51E-468E-457E-B954-FF1B9645CADB}", module_section_cv_matrices, { is_fx ? 2 : 5, 2, 3, 2 }, cv_matrix_modules);
  if (!is_fx)
  {
    result->gui.module_sections[module_section_vlfo] = make_module_section_gui(
      "{0DA0E7C3-8DBB-440E-8830-3B6087F23B81}", module_section_vlfo, { 7, 0, 1, 1 }, { 1, 1 });
    result->gui.module_sections[module_section_vfx] = make_module_section_gui(
      "{5BD5F320-3CA9-490B-B69E-36A003F41CEC}", module_section_vfx, { 6, 0, 1, 1 }, { 1, 1 });
    result->gui.module_sections[module_section_env] = make_module_section_gui(
      "{AB26F56E-DC6D-4F0B-845D-C750728F8FA2}", module_section_env, { 8, 0, 1, 1 }, { 1, 1 });
    result->gui.module_sections[module_section_osc] = make_module_section_gui(
      "{7A457CCC-E719-4C07-98B1-017EA7DEFB1F}", module_section_osc, { 4, 0, 1, 1 }, { { 1 }, { 1 } });
    result->gui.module_sections[module_section_voice_in] = make_module_section_gui(
      "{FB435C64-8349-4F0F-84FC-FFC82002D69F}", module_section_voice_in, { 5, 0, 1, 1 }, { { 1 }, { 1 } });
    result->gui.module_sections[module_section_voice_out] = make_module_section_gui(
      "{2B764ECA-B745-4087-BB73-1B5952BC6B96}", module_section_voice_out, { 5, 1, 1, 1 }, { { 1 }, { 1 } });
  }

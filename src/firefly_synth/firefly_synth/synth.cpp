...
synth_topo()
{
  ...
  result->modules[module_master_in] = master_in_topo(module_section_input, master_colors, { 0, 0 });
  result->modules[module_master_out] = master_out_topo(module_section_monitor_master, master_colors, { 0, 0 });

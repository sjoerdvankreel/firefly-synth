...
synth_topo(bool is_fx, std::string const& full_name)
{
  ...
  result->tuning_mode_param = is_fx ? -1 : master_settings_param_tuning_mode;
  ...
  result->modules[module_master_settings] = master_settings_topo(module_section_master_in, is_fx, { 0, 0 });
  ...
  result->modules[module_monitor] = monitor_topo(module_section_monitor, { 0, 0 }, result->audio_polyphony);

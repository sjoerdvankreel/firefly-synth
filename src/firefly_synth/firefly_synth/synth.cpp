...
make_module_graph_params(int module, 
  bool render_on_module_mouse_enter, bool render_on_param_mouse_enter, bool render_automation_state,
  bool hover_selects_different_graph, std::vector<int> const& dependent_module_indices)
{
  ...
  result.render_automation_state = render_automation_state;
  result.dependent_module_indices = dependent_module_indices;
  result.render_on_module_mouse_enter = render_on_module_mouse_enter;
  result.hover_selects_different_graph = hover_selects_different_graph;
...
make_module_graph_section(
  ...
  bool render_on_module_mouse_enter, bool render_on_param_mouse_enter, bool render_automation_state, bool hover_selects_different_graph,
  std::vector<int> const& dependent_module_indices, float partition_scale = 0.15f)
{
  ...
  module_graph_params module_params = make_module_graph_params(module, 
    render_on_module_mouse_enter, render_on_param_mouse_enter, render_automation_state, hover_selects_different_graph, dependent_module_indices);
...
make_main_graph_section(plugin_gui* gui, lnf* lnf, component_store store)
{
  ...
  module_params.render_automation_state = true;
  ...
  bool is_fx, int module_section, std::string const& name_in_theme)
{
  return store_component<tabbed_module_section_container>(store, gui, module_section,
    [gui, is_fx, lnf, module_section, name_in_theme](int module_index) -> std::unique_ptr<juce::Component> {
      ...
      switch (module_index)
      {
      case module_vaudio_audio_matrix: return std::make_unique<module_graph>(gui, lnf, params, make_module_graph_params(module_index, false, true, false, true, { }));
      case module_gaudio_audio_matrix: return std::make_unique<module_graph>(gui, lnf, params, make_module_graph_params(module_index, false, true, false, true, { }));
      case module_osc_osc_matrix: return std::make_unique<module_graph>(gui, lnf, params, make_module_graph_params(module_index, true, false, false, true,
        { module_osc, module_voice_in }));
      case module_vcv_audio_matrix: return std::make_unique<module_graph>(gui, lnf, params, make_module_graph_params(module_index, false, true, true, true,
      ...
      case module_gcv_audio_matrix: return std::make_unique<module_graph>(gui, lnf, params, make_module_graph_params(module_index, false, true, true, true,
        { module_global_in, module_glfo, module_gfx, module_gaudio_audio_matrix, module_global_out }));
      case module_vcv_cv_matrix: return std::make_unique<module_graph>(gui, lnf, params, make_module_graph_params(module_index, false, true, true, true,
        { module_global_in, module_glfo, module_gcv_audio_matrix, module_vlfo, module_env, module_vcv_audio_matrix }));
      case module_gcv_cv_matrix: return std::make_unique<module_graph>(gui, lnf, params, make_module_graph_params(module_index, false, true, true, true,
...
synth_topo(format_basic_config const* config, bool is_fx, std::string const& full_name)
{
  ...
  result->gui.custom_sections[custom_section_gfx_graph] = make_custom_section_gui(
    ...
    -> Component& { return make_module_graph_section(gui, lnf, store, module_gfx, gfx_graph_name, false, false, false, false, {}); });
  result->gui.custom_sections[custom_section_glfo_graph] = make_custom_section_gui(
    ...
    -> Component& { return make_module_graph_section(gui, lnf, store, module_glfo, glfo_graph_name, false, false, false, false, {}); });
  if (is_fx)
  {
  ...
  else
  {
    result->gui.custom_sections[custom_section_osc_graph] = make_custom_section_gui(
      ...
      -> Component& { return make_module_graph_section(gui, lnf, store, module_osc, osc_graph_name, false, false, false, false, { module_osc_osc_matrix, module_voice_in }); });
    result->gui.custom_sections[custom_section_vfx_graph] = make_custom_section_gui(
      ...
      -> Component& { return make_module_graph_section(gui, lnf, store, module_vfx, vfx_graph_name, false, false, false, false, {}); });
    result->gui.custom_sections[custom_section_vlfo_graph] = make_custom_section_gui(
      ...
      -> Component& { return make_module_graph_section(gui, lnf, store, module_vlfo, vlfo_graph_name, false, false, false, false, {}); });
    result->gui.custom_sections[custom_section_env_graph] = make_custom_section_gui(
      ...
      -> Component& { return make_module_graph_section(gui, lnf, store, module_env, env_graph_name, false, false, false, false, {}); });
    result->gui.custom_sections[custom_section_global_matrix_graphs] = make_custom_section_gui(
      custom_section_global_matrix_graphs, global_matrix_graphs_name, { 4, 4, 1, 2 }, [](auto* gui, auto* lnf, auto store)

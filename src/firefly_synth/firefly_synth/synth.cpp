...
enum { 
  ...
  module_section_voice_out_monitor, module_section_count };
...
synth_topo()
{
  ...
  result->gui.module_sections[module_section_g_lfo_fx] = make_module_section_gui(
    "{96C75EE5-577E-4508-A85A-E92FF9FD8A4D}", module_section_g_lfo_fx, { 2, 0, 1, 3 }, { 1, 2 });
  ...
  result->gui.module_sections[module_section_voice_out_monitor] = make_module_section_gui(
    "{8FDAEB21-8876-4A90-A8E1-95A96FB98FD8}", module_section_voice_out_monitor, { 7, 0, 1, 3 }, { { 1 }, { 1, 1 } });
  ...
  result->modules[module_voice_out] = audio_out_topo(module_section_voice_out_monitor, voice_colors, { 0, 0 }, false);
  result->modules[module_master_out] = audio_out_topo(module_section_master_in_out, global_colors, { 0, 1 }, true);
  result->modules[module_monitor] = monitor_topo(module_section_voice_out_monitor, monitor_colors, { 0, 1 }, result->polyphony);

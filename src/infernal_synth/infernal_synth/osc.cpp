...
osc_topo()
{
  ...
  result.params.emplace_back(param_toggle("{AA9D7DA6-A719-4FDA-9F2E-E00ABB784845}", "On", osc_group_main, param_direction::input, param_text::both, false));
  result.params.emplace_back(param_items("{960D3483-4B3E-47FD-B1C5-ACB29F15E78D}", "Type", osc_group_main, param_direction::input, param_display::list, param_text::both, type_items, "Saw"));
  result.params.emplace_back(param_percentage("{75E49B1F-0601-4E62-81FD-D01D778EDCB5}", "Gain", osc_group_main, param_direction::input, param_display::knob, param_text::both, param_rate::accurate, true, 0, 1, 1));
  result.params.emplace_back(param_percentage("{23C6BC03-0978-4582-981B-092D68338ADA}", "Bal", osc_group_pitch, param_direction::input, param_display::knob, param_text::both, param_rate::accurate, true, -1, 1, 0));
  result.params.emplace_back(param_steps("{38C78D40-840A-4EBE-A336-2C81D23B426D}", "Oct", osc_group_pitch, param_direction::input, param_display::list, param_text::both, 0, 9, 4));
  result.params.emplace_back(param_names("{78856BE3-31E2-4E06-A6DF-2C9BB534789F}", "Note", osc_group_pitch, param_direction::input, param_display::list, param_text::both, note_names(), "C"));
  result.params.emplace_back(param_percentage("{691F82E5-00C8-4962-89FE-9862092131CB}", "Cent", osc_group_pitch, param_direction::input, param_display::knob, param_text::both, param_rate::accurate, false, -1, 1, 0));
  return result;
}

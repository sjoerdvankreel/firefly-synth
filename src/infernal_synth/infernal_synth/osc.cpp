...
osc_topo()
{
  ...
  result.params.emplace_back(param_names("{78856BE3-31E2-4E06-A6DF-2C9BB534789F}", "Note", osc_group_pitch, param_display::list, note_names(), "C"));
  result.params.emplace_back(param_percentage("{691F82E5-00C8-4962-89FE-9862092131CB}", "Cent", osc_group_pitch, param_display::knob, param_rate::accurate, -1, 1, 0));
  return result;
}

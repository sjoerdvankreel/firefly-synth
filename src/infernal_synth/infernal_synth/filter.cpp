...
filter_topo()
{
  ...
  result.params.emplace_back(param_percentage("{B377EBB2-73E2-46F4-A2D6-867693ED9ACE}", "Osc Gain", 2, filter_section_main, param_dir::input, param_edit::vslider, param_label::both, param_rate::accurate, true, 0, 1, 0.5));
  result.params.emplace_back(param_percentage("{6AB939E0-62D0-4BA3-8692-7FD7B740ED74}", "Out Gain", 1, filter_section_main, param_dir::output, param_edit::text, param_label::both, param_rate::block, true, 0, 1, 0));
  return result;
}

...
filter_topo(int osc_slot_count)
{
  ...
  result.params.emplace_back(param_toggle(
    "{960E70F9-AB6E-4A9A-A6A7-B902B4223AF2}", "On", filter_param_on, 1, section_main, false,
    param_dir::input,
  ...
  result.params.emplace_back(param_log(
    "{02D1D13E-7B78-4702-BB49-22B4E3AE1B1F}", "Freq", filter_param_freq, 1, section_main, 20, 20000, 1000, 1000, 0, "Hz",

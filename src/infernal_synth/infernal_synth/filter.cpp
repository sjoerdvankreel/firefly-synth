...
filter_topo()
{
  ...
  result.params.emplace_back(param_percentage("{6AB939E0-62D0-4BA3-8692-7FD7B740ED74}", "Out Gain", filter_group_main, param_direction::output, param_edit::text, param_label::both, param_rate::block, true, 0, 1, 0));
  return result;
}

...
filter_topo(int osc_slot_count)
{
  ...
  result.params.emplace_back(param_log(
    ...
    section_main, param_dir::input, param_edit::knob, param_label_contents::default_, param_rate::accurate, 20, 20000, 1000, 1000, "Hz",
  ...
  result.params.emplace_back(param_pct(
    ...
    section_main, param_dir::input, param_edit::vslider, param_label_contents::default_, param_rate::accurate, true, 0, 1, 0.5,

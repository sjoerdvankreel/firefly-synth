...
enum { filter_param_on, filter_param_freq, filter_param_temp /* TODO */, filter_param_osc_gain };
...
enum { cv_matrix_param_on, cv_matrix_param_active, cv_matrix_param_source, cv_matrix_param_lfo_index, cv_matrix_param_env_index, cv_matrix_param_target, cv_matrix_param_osc_index, cv_matrix_param_osc_target, cv_matrix_param_filter_target };

...
enum { module_glfo, module_vlfo, module_env, module_cv_matrix, module_osc, module_filter, module_delay, module_count };
...
plugin_base::module_topo delay_topo(plugin_base::gui_position const& pos, int polyphony);
plugin_base::module_topo filter_topo(plugin_base::gui_position const& pos, int osc_slot_count);
plugin_base::module_topo lfo_topo(plugin_base::gui_position const& pos, int module, std::string const& name);

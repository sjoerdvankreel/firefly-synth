...
input_topo(int section, plugin_base::gui_colors const& colors, plugin_base::gui_position const& pos)
{
  module_topo result(make_module(
    ...
    make_module_dsp(module_stage::input, module_output::cv, 0, {
      ...
      make_module_dsp_output(true, make_topo_info("{91B915D6-0DCA-4F59-A396-6AF31DA28DBB}", "Mod", param_mod, 1)),
      make_module_dsp_output(false, make_topo_info("{EB8CBA31-212A-42EA-956E-69063BF93C58}", "PB", param_pb, 1)) }),

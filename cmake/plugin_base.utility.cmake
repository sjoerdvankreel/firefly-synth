...
function(declare_vst3_target WRAPPER_NAME WRAPPER_SOURCE PLUGIN_NAME IS_FX)
  ...
  target_link_libraries(${TARGET_NAME} ${PLUGIN_NAME} plugin_base plugin_base.vst3 pluginterfaces sdk sdk_common)
...
function(declare_clap_target WRAPPER_NAME WRAPPER_SOURCE PLUGIN_NAME IS_FX)
  ...
  target_include_directories(${TARGET_NAME} PRIVATE "src/${PLUGIN_NAME}" "${CMAKE_SOURCE_DIR}/base/src/plugin_base" "${CMAKE_SOURCE_DIR}/base/src/plugin_base.clap")
  target_link_libraries(${TARGET_NAME} ${PLUGIN_NAME} plugin_base plugin_base.clap)
  if(CMAKE_CXX_COMPILER_ID STREQUAL "MSVC")
    set_target_properties(${TARGET_NAME} PROPERTIES SUFFIX "")
    set(BUILD_TYPE "$<$<CONFIG:Debug>:Debug>$<$<CONFIG:Release>:Release>")

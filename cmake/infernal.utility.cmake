...
function(declare_vst3_target VST3_PROJECT_NAME PLUG_PROJECT_NAME)
  ...
  target_include_directories(${TARGET_NAME} PRIVATE "src/${PLUG_PROJECT_NAME}" "${CMAKE_SOURCE_DIR}/base/src/infernal.base" "${CMAKE_SOURCE_DIR}/base/src/infernal.base.vst3")

...
- Mac VST3: [firefly_synth_1.8.4_mac_vst3_instrument.zip](https://github.com/sjoerdvankreel/firefly-synth-storage/raw/main/release/firefly_synth_1.8.4_mac_vst3_instrument.zip)
- Mac VST3 Fx: [firefly_synth_1.8.4_mac_vst3_fx.zip](https://github.com/sjoerdvankreel/firefly-synth-storage/raw/main/release/firefly_synth_1.8.4_mac_vst3_fx.zip)
- Mac CLAP: [firefly_synth_1.8.4_mac_clap_instrument.zip](https://github.com/sjoerdvankreel/firefly-synth-storage/raw/main/release/firefly_synth_1.8.4_mac_clap_instrument.zip)
- Mac CLAP Fx: [firefly_synth_1.8.4_mac_clap_fx.zip](https://github.com/sjoerdvankreel/firefly-synth-storage/raw/main/release/firefly_synth_1.8.4_mac_clap_fx.zip)
- Linux VST3: [firefly_synth_1.8.4_linux_vst3_instrument.zip](https://github.com/sjoerdvankreel/firefly-synth-storage/raw/main/release/firefly_synth_1.8.4_linux_vst3_instrument.zip)
- Linux VST3 Fx: [release/firefly_synth_1.8.4_linux_vst3_fx.zip](https://github.com/sjoerdvankreel/firefly-synth-storage/raw/main/release/firefly_synth_1.8.4_linux_vst3_fx.zip)
- Linux CLAP: [firefly_synth_1.8.4_linux_clap_instrument.zip](https://github.com/sjoerdvankreel/firefly-synth-storage/raw/main/release/firefly_synth_1.8.4_linux_clap_instrument.zip)
- Linux CLAP Fx: [firefly_synth_1.8.4_linux_clap_fx.zip](https://github.com/sjoerdvankreel/firefly-synth-storage/raw/main/release/firefly_synth_1.8.4_linux_clap_fx.zip)
- Windows VST3: [firefly_synth_1.8.4_windows_vst3_instrument.zip](https://github.com/sjoerdvankreel/firefly-synth-storage/raw/main/release/firefly_synth_1.8.4_windows_vst3_instrument.zip)
- Windows VST3 Fx: [firefly_synth_1.8.4_windows_vst3_fx.zip](https://github.com/sjoerdvankreel/firefly-synth-storage/raw/main/release/firefly_synth_1.8.4_windows_vst3_fx.zip)
- Windows CLAP: [firefly_synth_1.8.4_windows_clap_instrument.zip](https://github.com/sjoerdvankreel/firefly-synth-storage/raw/main/release/firefly_synth_1.8.4_windows_clap_instrument.zip)
- Windows CLAP Fx: [firefly_synth_1.8.4_windows_clap_fx.zip](https://github.com/sjoerdvankreel/firefly-synth-storage/raw/main/release/firefly_synth_1.8.4_windows_clap_fx.zip)

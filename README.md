...
- Mac VST3: [firefly_synth_1.8.2_mac_vst3_instrument.zip](https://github.com/sjoerdvankreel/firefly-synth-storage/raw/main/release/firefly_synth_1.8.2_mac_vst3_instrument.zip)
- Mac VST3 Fx: [firefly_synth_1.8.2_mac_vst3_fx.zip](https://github.com/sjoerdvankreel/firefly-synth-storage/raw/main/release/firefly_synth_1.8.2_mac_vst3_fx.zip)
- Mac CLAP: [firefly_synth_1.8.2_mac_clap_instrument.zip](https://github.com/sjoerdvankreel/firefly-synth-storage/raw/main/release/firefly_synth_1.8.2_mac_clap_instrument.zip)
- Mac CLAP Fx: [firefly_synth_1.8.2_mac_clap_fx.zip](https://github.com/sjoerdvankreel/firefly-synth-storage/raw/main/release/firefly_synth_1.8.2_mac_clap_fx.zip)
- Linux VST3: [firefly_synth_1.8.2_linux_vst3_instrument.zip](https://github.com/sjoerdvankreel/firefly-synth-storage/raw/main/release/firefly_synth_1.8.2_linux_vst3_instrument.zip)
- Linux VST3 Fx: [release/firefly_synth_1.8.2_linux_vst3_fx.zip](https://github.com/sjoerdvankreel/firefly-synth-storage/raw/main/release/firefly_synth_1.8.2_linux_vst3_fx.zip)
- Linux CLAP: [firefly_synth_1.8.2_linux_clap_instrument.zip](https://github.com/sjoerdvankreel/firefly-synth-storage/raw/main/release/firefly_synth_1.8.2_linux_clap_instrument.zip)
- Linux CLAP Fx: [firefly_synth_1.8.2_linux_clap_fx.zip](https://github.com/sjoerdvankreel/firefly-synth-storage/raw/main/release/firefly_synth_1.8.2_linux_clap_fx.zip)
- Windows VST3: [firefly_synth_1.8.2_windows_vst3_instrument.zip](https://github.com/sjoerdvankreel/firefly-synth-storage/raw/main/release/firefly_synth_1.8.2_windows_vst3_instrument.zip)
- Windows VST3 Fx: [firefly_synth_1.8.2_windows_vst3_fx.zip](https://github.com/sjoerdvankreel/firefly-synth-storage/raw/main/release/firefly_synth_1.8.2_windows_vst3_fx.zip)
- Windows CLAP: [firefly_synth_1.8.2_windows_clap_instrument.zip](https://github.com/sjoerdvankreel/firefly-synth-storage/raw/main/release/firefly_synth_1.8.2_windows_clap_instrument.zip)
- Windows CLAP Fx: [firefly_synth_1.8.2_windows_clap_fx.zip](https://github.com/sjoerdvankreel/firefly-synth-storage/raw/main/release/firefly_synth_1.8.2_windows_clap_fx.zip)
...
- Fun with supersaw (Detuned saw + more bells + kkick 7 + closed hat 4 + bass 4): [fun_with_supersaw.mp3](https://github.com/sjoerdvankreel/firefly-synth-storage/raw/main/render/fun_with_supersaw.mp3)

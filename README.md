...
- Linux VST3: [firefly_synth_1.7.7_linux_vst3_instrument.tar.gz](https://github.com/sjoerdvankreel/firefly-synth-storage/raw/main/release/firefly_synth_1.7.7_linux_vst3_instrument.tar.gz)
- Linux VST3 Fx: [release/firefly_synth_1.7.7_linux_vst3_fx.tar.gz](https://github.com/sjoerdvankreel/firefly-synth-storage/raw/main/release/firefly_synth_1.7.7_linux_vst3_fx.tar.gz)
- Linux CLAP: [firefly_synth_1.7.7_linux_clap_instrument.tar.gz](https://github.com/sjoerdvankreel/firefly-synth-storage/raw/main/release/firefly_synth_1.7.7_linux_clap_instrument.tar.gz)
- Linux CLAP Fx: [firefly_synth_1.7.7_linux_clap_fx.tar.gz](https://github.com/sjoerdvankreel/firefly-synth-storage/raw/main/release/firefly_synth_1.7.7_linux_clap_fx.tar.gz)
